...
public class OrderListAllDelegate extends LatteDelegate {
    ...
    public Object setLayout() {
        return R.layout.delegate_order_list_all;
    }
        ...
        query.findInBackground(new FindCallback<AVObject>() {
            ...
            public  void done(List<AVObject> list, AVException e) {
                if (e == null) {
                    ...
                    mRecyclerView.addOnItemTouchListener(new OrderListClickListener(OrderListAllDelegate.this));
